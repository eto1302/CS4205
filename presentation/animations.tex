...
{
  \renewcommand{\bginsert}{\hfill\raisebox{-0.9\paperheight}{\color{tud LightPurple}%
    \clap{\hspace*{0.4\paperwidth}\includegraphics[width=1.7\paperwidth]{figures/Library_TUDelft_sunny.jpg}}}\hfill}
  \section{Animations}
}
