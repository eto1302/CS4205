...
\renewcommand{\bginsert}{\textcolor{tud RoyalBlue}{\hspace{-0.55\paperwidth}%
  \raisebox{-0.3\paperheight}{\tudflame[1.2\paperwidth]}}}
\leftfooterwhitetrue
...
{
\setbeamercolor{background canvas}{bg=tud DarkGrey!15,fg=white}
...
\renewcommand{\bginsert}{\textcolor{tud RoyalBlue}{\hspace{0.2\paperwidth}%
  \raisebox{-0.3\paperheight}{\tudflame[1.2\paperwidth]}}}
...
\begin{frame}[t]{Colors}
  \begin{columns}[T, onlytextwidth]
    \begin{column}{0.5\textwidth}
      ...
      \begin{tabular}{>{\color{tud Blue}\bfseries}l|S}
        \rowcolor{tud Blue}
