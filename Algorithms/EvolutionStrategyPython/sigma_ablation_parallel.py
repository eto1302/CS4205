"""Parallel sigma-strategy ablation runner.
...
This script is non-destructive and leaves the sequential `sigma_ablation.py`
unchanged.
"""
import os
import csv
...
from sigma_ablation import run_one, TREATMENTS, CIRCLE_SIZES, N_SEEDS, TOLS, MAX_EVALS
...
def main():
    ...
    # Header
    print("=== Parallel sigma ablation ===", flush=True)
